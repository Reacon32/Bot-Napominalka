...
async def set_commands(bot: Bot):
    commands = [
        ...
        types.BotCommand(command='/add', description='Команда для добавления задач'),
        types.BotCommand(command='/list', description='Команда вызывающая список задач'),
        types.BotCommand(command='/delete', description='Команда удаляющая задачи'),
    ]
...
async def start(message: types.Message):
    await message.reply('Привет, я бот который поможет простроить твой день правильно')
